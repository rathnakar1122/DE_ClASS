...
delivered_table_spec = 'dev-project-433015:food_orders.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'dev-project-433015.food_orders.other_status_orders'
...
dataset_id = "dev-project-433015.food_orders"
